 // PERSONNEL Table
 export const PERSONNEL_TABLE_STRING =[ "STT","TÊN CHỨC VỤ","MÔ TẢ CHỨC VỤ","NGÔN NGỮ LẬP TRÌNH","MỨC LƯƠNG TỐI THIỂU","THAO TÁC"];
 export const PERSONNEL_TITLE_STRING = "QUẢN LÝ CHỨC VỤ";
 //Modal
...
export const PERSONNEL_TABLE_PROTOTYPE = [ "id", "name", "description", "programing_language", "salary" ]
