...
export const TEAM_TABLE_STRING =[ "STT","TÊN NHÓM","MÔ TẢ","TRƯỞNG NHÓM","NGÀY LẬP NHÓM","THAO TÁC"];
export const TEAM_TITLE_STRING = "QUẢN LÝ ĐỘI NHÓM";
export const TEAM_TABLE_PROTOTYPE = [ "id", "name","descriptions", "num_member", "leader","date_start"]
