...
import Loading from './../../component/Loading/Loading';
 class TableDegrees extends Component {
  state = {
    status : '',
    repos: 0 ,
    msgerr : '',
 ...
 onChangeSearch=(e)=> {
  ...
  loadingDataSearch =async () => {
    ...
    callApiPaging('degrees',null,null,this.state.page+"&search="+this.refs.search.value)
        .then(async(response) => {
            await this.setState({ 
  ...
  loadingData =async () => {
    ...
    callApiPaging('degrees',null,null,this.state.page)
        .then(async(response) => {
            await this.setState({ 
              repos: response.data.results,
       ...
       confirmDelete =async (idDelete) =>{
        this.setState({ 
            ...
            await callApiDelete(`degree`, null, "null",idDelete)
      ...
      if(repos.length > 0){
          result = repos.map((tableJson, index) =>{
            ...
            {/* data-toggle="modal" data-target="#exampleModalDelete" */}
                ...
                <NavLink to={`/trang-chu/bang-cap/sua/${tableJson[prototype[0]]}`} activeClassName="active"><button className="btn btn-primary btn-xs madow" title="Sửa" ><span class="glyphicon glyphicon-edit"></span> </button> </NavLink>  &nbsp;
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Xóa bằng cấp</h4>
                    </div>
            ...
            <div className="row">
              <div className="col-xs-12">
                <div className="box">
                  ...
                  <div className="title">Quản lý bằng cấp </div> 
                  </div>
                  <div className="col-xs-1" >
                  
                   <NavLink to={`/trang-chu/bang-cap/them`} activeClassName="active" >
                   {(authorization() == ADMIN) ?
