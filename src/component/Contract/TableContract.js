      ...
      if(repos.length > 0){
          result = repos.map((tableJson, index) =>{
            ...
            {/* data-toggle="modal" data-target="#exampleModalDelete" */}
                ...
                <NavLink to={`/trang-chu/hop-dong/sua/${tableJson[prototype[0]]}`} activeClassName="active"><button className="btn btn-primary btn-xs madow" title="Sửa" ><span class="glyphicon glyphicon-edit"></span> </button> </NavLink>  &nbsp;
